...
# @Name    : test_monitoring_realTimeMonitoring
...
class Test_MapIndex():
    ...
    @allure.story('通过建筑获取实时监控及实时监测类型告警数据')
    @allure.severity('critical')
    def test_monitoring_realTimeMonitoring_pass(self, request_init, assert_init, params_init):
        """
        用例描述：通过点击左侧列表建筑获取实时监控及实时监测类型告警数据正向用例
