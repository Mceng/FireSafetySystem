...
class Request:
    ...
    def run_request(self,*args,**kwargs):
        ...
        elif kwargs['method'] == 'post_multipart':
    ...
    def post_request(self, url,data=None, json=None,headers=None, **kwargs):
        """
        Post请求
        :param url:
        :param data:
        ...
        try:
            response = requests.post(url=url, data=data, json=json, headers=headers, verify=False)
    ...
    def put_request(self, url,json=None,data=None, headers=None):
        """
        Put请求
        :param url:
        :param data:
        ...
        try:
            response = requests.put(url=url, json=json,data=data, headers=headers)
    ...
    def delete_request(self, url,json=None,data=None, headers=None):
        """
        delete请求
        :param url:
        :param data:
        ...
        try:
            response = requests.delete(url=url, json=json,data=data ,headers=headers)
